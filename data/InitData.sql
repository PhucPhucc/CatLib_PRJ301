...
INSERT INTO Author (AuthorID, Name, Story) VALUES
(101, N'Nguyễn Nhật Ánh', N'Nguyễn Nhật Ánh là nhà văn nổi tiếng với các tác phẩm về tuổi học trò.'),
(102, N'Stephen Hawking', N'Stephen Hawking là nhà vật lý lý thuyết và vũ trụ học người Anh.'),
(103, N'Trần Trọng Kim', N'Trần Trọng Kim là một học giả, nhà sử học và chính khách Việt Nam.'),
(104, N'Nguyễn Du', N'Nguyễn Du là đại thi hào dân tộc Việt Nam, tác giả của Truyện Kiều.'),
(105, N'Tô Hoài', N'Tô Hoài là nhà văn Việt Nam nổi tiếng với Dế Mèn Phiêu Lưu Ký.');
...
INSERT INTO [Order] (OrderID, UserID, BookID, OrderDate, ReturnDate, ActualReturnDate, Bill, Status) VALUES
